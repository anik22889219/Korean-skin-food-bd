          ...
          <div className="lg:col-span-4 space-y-4">
            <Link to="/" className="flex items-center gap-2.5 group">
              ...
              <div>
                ...
                <p className="text-[10px] text-pink-600 mt-1 font-bold tracking-wider">
                  K-BEAUTY COSMECEUTICALS
                </p>
              </div>
            </Link>
            ...
            <div id="footer_social_links" className="pt-2 space-y-2.5">
              ...
              <div className="flex items-center gap-3">
                {/* Facebook Button */}
                <a
                  href="https://www.facebook.com/Koreanskinfood"
                  target="_blank"
                ...
                {/* Instagram Button */}
                <a
                  href="https://www.instagram.com/korean_skin_food_2579/"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <div className="space-y-3 text-gray-600 font-semibold">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="tel:+8801700000000" className="hover:text-[#E91E8C] font-mono font-bold transition-colors">
                  +880 1700-000000
                </a>
              </div>
              <div className="flex items-center gap-2.5">
                <Mail size={16} className="text-[#E91E8C] shrink-0" />
                <a href="mailto:koreanskinfood.bd@gmail.com" className="hover:text-[#E91E8C] transition-colors truncate">
                  koreanskinfood.bd@gmail.com
                </a>
              </div>
        ...
        <div className="border-t border-pink-100 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left text-[11px] font-semibold text-gray-500">
          <div>
            <p className="font-extrabold text-pink-700">
              Korean Skin Food BD &copy; 2026. All rights reserved.
            </p>
